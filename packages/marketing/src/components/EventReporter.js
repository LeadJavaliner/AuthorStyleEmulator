  ...
  return (
    <div>
      ...
      <table>
        ...
        <tfoot>
          <tr>
            <td colSpan="3" align="right"><strong>Total Possible Revenue:</strong></td>
            <td colSpan="2">${totalPossibleRevenue}</td>
          </tr>
          <tr>
            <td colSpan="3" align="right"><strong>Current Total Ticket Sales:</strong></td>
            <td colSpan="2">{totalCurrentSales}</td>
          </tr>
          <tr>
            <td colSpan="3" align="right"><strong>Total Current Revenue:</strong></td>
