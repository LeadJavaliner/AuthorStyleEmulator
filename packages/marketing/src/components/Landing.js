      ...
      <main>
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography >
            <img src="https://turinglimited.com/assets/brand/qrcode-with-average-bkgcolor.PNG" with="400" height="200" />
            </Typography>
            <Typography
              variant="h5"
              align="center"
            ...
            <div className={classes.heroButtons}>
              ...
              <Grid item>
                    <Link to="/assetsecurityusecases">
                      <Button variant="contained" color="primary">
                        Asset Security Use Cases
                      </Button>
                    </Link>
                </Grid>
                <Grid item>
